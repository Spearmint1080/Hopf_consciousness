...
if ~isfield(Cfg, 'TRsec'), Cfg.TRsec = 3.29; else end;
...
nn=0;
    ...
    for t=1:dt:Tmax*Cfg.TRsec*nSubs %check for the specific data
        ...
        dW = (dt*(-0.01*W+.005*z(:,1)*z(:,1)')).*wC_mask; % only real part for weight update
